  ...
  return (
    <div className="min-h-screen bg-(--color-bg) flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div>
          <h2 className="mt-6 text-center text-3xl font-extrabold color(--color-text-primary)">Sign in to your account</h2>
        </div>

        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="space-y-4">
            <div>
              <label htmlFor="email" className="block text-sm font-medium color(--color-text-secondary)">
                Email
              </label>
              <input
                {...register("email", {
            ...
            <div>
              <label htmlFor="password" className="block text-sm font-medium color(--color-text-secondary)">
                Password
              </label>
              <input
